...
f_cubic = fit(O2',Q','poly3','Normalize','on','Robust','Bisquare');
[paras_cubic, stats_cubic] = fit(O2',Q','poly3','Normalize','on','Robust','Bisquare');
settings_cubic = [paras_cubic.p1 paras_cubic.p2 paras_cubic.p3 paras_cubic.p4];
xx = 1;
xx = (xx - 50) / 29.3;
xx = -0.53;
ttt = (xx*xx*xx*(0.004172)) + (xx*xx*0.024304) + (xx*(-0.089222)) + 0.259458;
% 0.193   87.4
% 0.191   100
% 0.196   83.1
% 0.195   83.6
...
[settings, sse, f, type] = fitFunc(O2, Q);
